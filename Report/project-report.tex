...
\section{Topology and basic configurations}

Section to explain the projects topology briefly and to mention the use of routers cisco 3275 as pcs (changed the icon in gns3 to a pc icon)

\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\linewidth]{../Images/Project Topology.png}
    \caption{Project topology, group members and Key server highlighted}
    \label{fig:topology}
\end{figure}
